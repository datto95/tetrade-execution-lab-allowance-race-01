...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate and validate evidence for allowance-race-01")
    ...
    evidence = {
        ...
        "assertions": {
            "exploitConfirmed": "testAllowanceRaceDrainsOldPlusNewOnVulnerable" in output,
            "fixConfirmed": "testFixedVaultBlocksNonZeroToNonZeroApprove" in output,
            "negativeControlConfirmed": "testNegativeControlZeroResetThenReapproveWorks" in output,
        },
